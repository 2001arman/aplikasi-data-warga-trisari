 ...
 * @author Armann
 */
public class rt23 extends javax.swing.JFrame {

    String nomor, nama, jumlah, ekonomi,id, agama;
        ...
        if (nama.isEmpty() | nomor.isEmpty() | jumlah.isEmpty()){
            ...
            try{
                ...
                if(betul == false){
                    ...
                    String sql = "INSERT INTO `rt23`(`nomor`, `nama`, `jumlah`, `golongan`, `agama`, `rt`) VALUES ('%s','%s','%s','%s','%s','%s')";
    ...
    private void perbarui1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_perbarui1ActionPerformed
        String namaB = namaKeluarga1.getText();
        String nomor = nomorRumah1.getText();
        String jumlah = jumlahKeluarga1.getText();
        String agama = agamaTxt.getSelectedItem().toString();
        if(nama.isEmpty() | nomor.isEmpty() | jumlah.isEmpty()){
            ...
            try{
                ...
                stmt = conn.createStatement();
                String golongan = cbgolongan1.getSelectedItem().toString();
                String sql = "UPDATE rt23 SET nomor='%s',nama='%s',jumlah='%s',golongan='%s',agama='%s'  WHERE nomor=%s";
    ...
    private void hapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapus1ActionPerformed
        try{
            ...
            String nama = namaKeluarga1.getText();
            String golongan = cbgolongan1.getSelectedItem().toString();
            String sql = "DELETE FROM `rt23` WHERE nomor = '%s'";
    ...
    private void warga1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_warga1MouseClicked
        ...
        agama = warga1.getValueAt(baris, 4).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rt23.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
